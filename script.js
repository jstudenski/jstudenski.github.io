      ...
      if (document.getElementById('lr-left').checked) { // Left Store
        if (sixRepeat > 0) {
          if (fiveRepeat == 1) {
            ...
            fiveStartKit = 1; // Place Next to Starter Kit
            ...
            if (fourRepeat == 1) {
              ...
              fourStartKit = 1; // Place Next to Starter Kit

            } else if (fourRepeat > 1) {
              fourEnd = 1;
              fourRepeat -= 1;   
          ...
          if (threeRepeat == 1) {
            fourEnd = 1;
            fourRepeat -= 1;
            threeStartKit = 1; // Place Next to Starter Kit
          } else if (threeRepeat > 1) {
            threeEnd = 1;
            threeRepeat -= 1;   
            threeStartKit = 1; // Place Next to Starter Kit
          } else if (threeRepeat == 0 ) {
            fourEnd = 1;
            fourRepeat -= 1;
          }
      } else if (threeRepeat > 0) {
...
//  Merchandising Diagram
  ...
  if(document.getElementById('height-low').checked) { // Merchandising Diagram Low Counter
  ...
  } else if(document.getElementById('height-high').checked) { // Merchandising Diagram High Counter
  ...
  if (document.getElementById('bcext-yes').checked) {
    ...
    $('#diagramthree').append('<div class="child pegboard height33 bluecounter">' + 'AF' + (3) + '<br>48x25</div>');
      ...
      var merch1 = 'LATEX-1'
      var merch2 = 'LATEX-2'
      var merch3 = 'SAT' // singmerch
      var merch4 = 'ORBS' // ultramerch
      var merch5 = 'GLIDE' // glidemerch

  if(document.getElementById('ds15-no').checked) {  // No - Old 2015 Design Studio
    if (document.getElementById('bsext-yes').checked && document.getElementById('dstud-yes').checked) { 
      $('#diagramthree').append('<div class="child uprite60"></div>');
      $('#diagramthree').append('<div class="child pegboard height60 glidemerch">' + merch5 + '<br>48x52</div>');
      $('#diagramthree').append('<div class="child uprite60"></div>');
      $('#diagramthree').append('<div class="child pegboard height60 ultramerch">' + merch4 + '<br>48x52</div>');
      $('#diagramthree').append('<div class="child uprite60"></div>');
      $('#diagramthree').append('<div class="child pegboard height60 singmerch">' + merch3 + '<br>48x52</div>');
    }  else if (document.getElementById('bsext-yes').checked) { 
      $('#diagramthree').append('<div class="child uprite60"></div>');
      $('#diagramthree').append('<div class="child pegboard height60 singmerch">' + merch3 + '<br>48x52</div>');
    }  else if (document.getElementById('dstud-yes').checked) { 
    ...
    $('#diagramthree').append('<div class="child uprite60"></div>');
  }else if(document.getElementById('ds15-yes').checked) {  // Yes - Old 2015 Design Studio
    $('#diagramthree').append('<div class="child uprite33 grayout"></div>');
    $('#diagramthree').append('<div class="child pegboard height33 grayout graybg "></div>'); 
    $('#diagramthree').append('<div class="child uprite33 grayout"></div>');
    $('#diagramthree').append('<div class="child pegboard height33 grayout graybg"></div>');
    $('#diagramthree').append('<div class="child uprite33 grayout"></div>');
  }
...
if (document.getElementById('dstud-yes').checked) {
     ...
     //   $('#diagramthree').append('<div class="child uprite60"></div>');
     //   $('#diagramthree').append('<div class="child pegboard height60">' + merch5 + '<br>48x52</div>');
     // } 
     // $('#diagramthree').append('<div class="child uprite60"></div>');
     // $('#diagramthree').append('<div class="child pegboard height60">' + merch4 +  '<br>48x52</div>');
     // $('#diagramthree').append('<div class="child uprite60"></div>');
     // $('#diagramthree').append('<div class="child pegboard height60">' + merch3 + '<br>48x52</div>');
     // $('#diagramthree').append('<div class="child uprite60"></div>');
     // $('#diagramthree').append('<div class="child pegboard height60">' + merch2 + '<br>48x52</div>');
     // $('#diagramthree').append('<div class="child uprite60"></div>');
     // $('#diagramthree').append('<div class="child pegboard height60">' + merch1 + '<br>48x52</div>');
...
//   if(document.getElementById('ds15-no').checked) {  // No 2015 Design Studio
//     $('#diagramthree').append('<div class="child uprite60"></div>');
//     $('#diagramthree').append('<div class="child pegboard height60">' + 'LATEX-' + (1) +  '<br>48x52</div>');
//     $('#diagramthree').append('<div class="child uprite60"></div>');
//     $('#diagramthree').append('<div class="child pegboard height60">' + 'LATEX-' + (2) + '<br>48x52</div>');
//     $('#diagramthree').append('<div class="child uprite60"></div>');

//       // Balloon Service Extension
//       if (document.getElementById('bsext-yes').checked) {
//         $('#diagramthree').append('<div class="child pegboard height60">' + 'SAT' + '<br>48x52</div>');
//         $('#diagramthree').append('<div class="child uprite60"></div>');
//       }

//   }else if(document.getElementById('ds15-yes').checked) {  // Yes 2015 Design Studio

//       if (document.getElementById('bsext-yes').checked) { // Yes Balloon Service Extension
//         $('#diagramthree').append('<div class="child uprite60"></div>');
//         $('#diagramthree').append('<div class="child pegboard height60">' + 'LATEX-' + (1) +  '<br>48x52</div>'); 
//         $('#diagramthree').append('<div class="child uprite60"></div>');
//       }
//       if (document.getElementById('bsext-no').checked) { // No Balloon Service Extension
//         $('#diagramthree').append('<div class="child uprite33 grayout"></div>');
//       }
...
//   }
 ...
 // Dummy Box
  ...
  //Reverse Merchandising diagram div order (for right)  
...
//  End Merchandising Diagram
  ...
  if(document.getElementById('lr-left').checked) { // left handed store
    ...
    populateDiagram('#repeatarea', (threeRepeat - threeStartKit), '<div class="three"><img src="sprites/counter_3.svg" width="42px"><p>' + '3ft 6in' + '</p></div>');
    populateDiagram('#repeatarea', (fourRepeat - fourStartKit), '<div class="four"><img src="sprites/counter_4.svg" width="48px"><p>' + '4ft' + '</p></div>');
    populateDiagram('#repeatarea', (fiveRepeat - fiveStartKit), '<div class="five"><img src="sprites/counter_5.svg" width="60px"><p>' + '5ft' + '</p></div>');
    populateDiagram('#repeatarea', sixRepeat, '<div class="six"><img src="sprites/counter_6.svg" width="72px"><p>' + '6ft' + '</p></div>');

 // Place Next to Starter Kit
    populateDiagram('#repeatarea', threeStartKit, '<div class="three"><img src="sprites/counter_3.svg" width="42px"><p>' + '3ft 6in' + '</p></div>');
    populateDiagram('#repeatarea', fourStartKit, '<div class="four"><img src="sprites/counter_4.svg" width="48px"><p>' + '4ft' + '</p></div>');
    populateDiagram('#repeatarea', fiveStartKit, '<div class="five"><img src="sprites/counter_5.svg" width="60px"><p>' + '5ft' + '</p></div>');
 //
...
function generatecounterParts() {
  ...
  subtotal = parseFloat(registerTotalCost.toFixed(2))
  shippingFee = 210.67
  ...
  // Add Total Column  
   $("#countertoptable").append(
        "<tr>" +
          ...
          "<td class=\"part\">"  + "</td>" +
          "<td class=\"description\">"  + "</td>" +
          "<td class=\"center price\">" + "<b>Subtotal:</b>" + "</td>" +
   ...
   $("#countertoptable").append(
        "<tr>" +
          ...
          "<td class=\"part\">"  + "</td>" +
          "<td class=\"description\">"  + "</td>" +
          "<td class=\"center price\">" + "<b>Handling:</b>" + "</td>" +
          "<td class=\"total\">" + "<b>" +  shippingFee + "</b>" + "</td>" +          
        "</tr>"
    );
   ...
   $("#countertoptable").append(
        "<tr>" +
          ...
          "<td class=\"total\">" + "<b>" + (subtotal + shippingFee).toFixed(2) + "</b>" + "</td>" +          
        "</tr>"
    );
...
function counterAddRow(variable, part, description, price) {
  if (variable > 0) {
    ...
    "<tr>" +
      ...
      "<td class=\"part\">" + part + "</td>" +
      "<td class=\"description\">" + description + "</td>" +
      "<td class=\"center price\">" + (price * markup).toFixed(2) + "</td>" +
      "<td class=\"total\">" + ((price * markup).toFixed(2)*variable).toFixed(2) + "</td>" + 
    "</tr>"
    );
    registerTotalCost += (price * markup).toFixed(2)*variable;
//    registerTotalCost = parseInt(registerTotalCost);
  }
